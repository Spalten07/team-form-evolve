                      ...
                      {["08:00", "08:15", "08:30", "08:45", "09:00", "09:15", "09:30", "09:45", "10:00", "10:15", "10:30", "10:45", "11:00", "11:15", "11:30", "11:45", "12:00", "12:15", "12:30", "12:45", "13:00", "13:15", "13:30", "13:45", "14:00", "14:15", "14:30", "14:45", "15:00", "15:15", "15:30", "15:45", "16:00", "16:15", "16:30", "16:45", "17:00", "17:15", "17:30", "17:45", "18:00", "18:15", "18:30", "18:45", "19:00", "19:15", "19:30", "19:45", "20:00", "20:15", "20:30", "20:45", "21:00", "21:15", "21:30", "21:45", "22:00"].map((time, idx) => (
                        <>
                          ...
                          <div className="border-r border-t relative">
                            {time === "08:00" && (activityFilter === "all" || activityFilter === "training") && (
                              <div className="absolute inset-0 bg-success/30 p-2 flex flex-col justify-start z-10" style={{ gridRow: `span 4` }}>
                                <p className="text-xs font-bold text-success">Möte 1</p>
                              </div>
                            )}
                            {time === "09:00" && (activityFilter === "all" || activityFilter === "training") && (
                              <div className="absolute inset-0 bg-success/30 p-2 flex flex-col justify-start z-10" style={{ gridRow: `span 8` }}>
                                <p className="text-xs font-bold text-success">Möte 2</p>
                              </div>
                            )}
                            {time === "11:00" && (activityFilter === "all" || activityFilter === "training") && (
                              <div className="absolute inset-0 bg-success/30 p-2 flex flex-col justify-start z-10" style={{ gridRow: `span 4` }}>
                                <p className="text-xs font-bold text-success">Möte 3</p>
                              </div>
                            )}
                            {time === "13:00" && (activityFilter === "all" || activityFilter === "training") && (
                              <div className="absolute inset-0 bg-success/30 p-2 flex flex-col justify-start z-10" style={{ gridRow: `span 8` }}>
                                <p className="text-xs font-bold text-success">Möte 4</p>
                              </div>
                            )}
                          </div>
                          {/* Tisdag */}
                          <div className="border-r border-t relative">
                            {time === "10:00" && (activityFilter === "all" || activityFilter === "training") && (
                              <div className="absolute inset-0 bg-success/30 p-2 flex flex-col justify-start z-10" style={{ gridRow: `span 4` }}>
                                <p className="text-xs font-bold text-success">Möte 5</p>
                              </div>
                            )}
                            {time === "11:00" && (activityFilter === "all" || activityFilter === "training") && (
                              <div className="absolute inset-0 bg-warning/40 p-2 flex flex-col justify-start z-10" style={{ gridRow: `span 28` }}>
                                <p className="text-xs font-bold text-warning-foreground">Möte 6</p>
                              </div>
                            )}
                            {time === "13:00" && (activityFilter === "all" || activityFilter === "training") && (
                              <div className="absolute inset-0 bg-warning/40 p-2 flex flex-col justify-start z-10" style={{ gridRow: `span 16` }}>
                                <p className="text-xs font-bold text-warning-foreground">Möte 7</p>
                              </div>
                            )}
                          </div>
                          {/* Onsdag */}
                          <div className="border-r border-t relative">
                            {time === "08:00" && (activityFilter === "all" || activityFilter === "training") && (
                              <div className="absolute inset-0 bg-success/30 p-2 flex flex-col justify-start z-10" style={{ gridRow: `span 4` }}>
                                <p className="text-xs font-bold text-success">Möte 8</p>
                              </div>
                            )}
                            {time === "09:30" && (activityFilter === "all" || activityFilter === "training") && (
                              <div className="absolute inset-0 bg-warning/40 p-2 flex flex-col justify-start z-10" style={{ gridRow: `span 6` }}>
                                <p className="text-xs font-bold text-warning-foreground">Möte 9</p>
                              </div>
                            )}
                            {time === "13:00" && (activityFilter === "all" || activityFilter === "training") && (
                              <div className="absolute inset-0 bg-success/30 p-2 flex flex-col justify-start z-10" style={{ gridRow: `span 4` }}>
                                <p className="text-xs font-bold text-success">Möte 10</p>
                              </div>
                            )}
                            {time === "14:00" && (activityFilter === "all" || activityFilter === "training") && (
                              <div className="absolute inset-0 bg-success/30 p-2 flex flex-col justify-start z-10" style={{ gridRow: `span 4` }}>
                                <p className="text-xs font-bold text-success">Möte 11</p>
                              </div>
                            )}
                            {time === "15:00" && (activityFilter === "all" || activityFilter === "training") && (
                              <div className="absolute inset-0 bg-success/30 p-2 flex flex-col justify-start z-10" style={{ gridRow: `span 4` }}>
                                <p className="text-xs font-bold text-success">Möte 12</p>
                              </div>
                            )}
                          </div>
                          {/* Torsdag */}
                          <div className="border-r border-t relative">
                            {time === "08:00" && (activityFilter === "all" || activityFilter === "training") && (
                              <div className="absolute inset-0 bg-success/30 p-2 flex flex-col justify-start z-10" style={{ gridRow: `span 4` }}>
                                <p className="text-xs font-bold text-success">Möte 13</p>
                              </div>
                            )}
                            {time === "09:30" && (activityFilter === "all" || activityFilter === "training") && (
                              <div className="absolute inset-0 bg-success/30 p-2 flex flex-col justify-start z-10" style={{ gridRow: `span 4` }}>
                                <p className="text-xs font-bold text-success">Möte 14</p>
                              </div>
                            )}
                            {time === "11:00" && (activityFilter === "all" || activityFilter === "training") && (
                              <div className="absolute inset-0 bg-success/30 p-2 flex flex-col justify-start z-10" style={{ gridRow: `span 8` }}>
                                <p className="text-xs font-bold text-success">Möte 15</p>
                              </div>
                            )}
                            {time === "13:00" && (activityFilter === "all" || activityFilter === "training") && (
                              <div className="absolute inset-0 bg-success/30 p-2 flex flex-col justify-start z-10" style={{ gridRow: `span 8` }}>
                                <p className="text-xs font-bold text-success">Möte 16</p>
                              </div>
                            )}
                            {time === "14:00" && (activityFilter === "all" || activityFilter === "training") && (
                              <div className="absolute inset-0 bg-success/30 p-2 flex flex-col justify-start z-10" style={{ gridRow: `span 4` }}>
                                <p className="text-xs font-bold text-success">Möte 17</p>
                              </div>
                            )}
                          </div>
                          {/* Fredag */}
                          <div className="border-r border-t relative">
                            {time === "08:00" && (activityFilter === "all" || activityFilter === "training") && (
                              <div className="absolute inset-0 bg-warning/40 border-t-4 border-warning p-2 flex flex-col justify-start z-10" style={{ gridRow: `span 2` }}>
                                <p className="text-xs font-bold text-warning-foreground">Anteckning 1</p>
                              </div>
                            )}
                            {time === "08:30" && (activityFilter === "all" || activityFilter === "training") && (
                              <div className="absolute inset-0 bg-warning/60 border-t-4 border-warning p-2 flex flex-col justify-start z-10" style={{ gridRow: `span 2` }}>
                                <p className="text-xs font-bold text-warning-foreground">Anteckning 2</p>
                              </div>
                            )}
                            {time === "09:00" && (activityFilter === "all" || activityFilter === "training") && (
                              <div className="absolute inset-0 bg-success/30 p-2 flex flex-col justify-start z-10" style={{ gridRow: `span 8` }}>
                                <p className="text-xs font-bold text-success">Möte 18</p>
                              </div>
                            )}
                            {time === "09:30" && (activityFilter === "all" || activityFilter === "training") && (
                              <div className="absolute inset-0 bg-success/30 p-2 flex flex-col justify-start z-10" style={{ gridRow: `span 6` }}>
                                <p className="text-xs font-bold text-success">Möte 19</p>
                              </div>
                            )}
                            {time === "11:00" && (activityFilter === "all" || activityFilter === "training") && (
                              <div className="absolute inset-0 bg-warning/40 p-2 flex flex-col justify-start z-10" style={{ gridRow: `span 8` }}>
                                <p className="text-xs font-bold text-warning-foreground">Möte 20</p>
                              </div>
                            )}
                          </div>
                          {/* Lördag */}
                          <div className="border-r border-t relative">
                            {time === "17:00" && (activityFilter === "all" || activityFilter === "match") && (
                              <div className="absolute inset-0 bg-accent/20 border-l-4 border-accent p-2 flex flex-col justify-start z-10" style={{ gridRow: `span 6` }}>
                          ...
                          <div className="border-t relative">
                            {time === "18:00" && (activityFilter === "all" || activityFilter === "training") && (
                              <div className="absolute inset-0 bg-primary/20 border-l-4 border-primary p-2 flex flex-col justify-start z-10" style={{ gridRow: `span 6` }}>
